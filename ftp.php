...
class Ftp
{
        ...
        public function download($dir = ".", $localDir = "./") {
            ...
            foreach($list as $item) {
                ...
                if ($this->isDir($item)) {
                    if (!is_dir($localDir.$item)) {
                        mkdir($localDir.$item);
                    }
                    $i += $this->download($item, $localDir);
                } else {
                    $file = $item;
                    echo $file;
                    if ($this->get($localDir.$file,$file,Ftp::BINARY)) {
                        ++$i;
                    } else {
                        throw FtpException("File ".$file." could not be copied");
                    }
                }
